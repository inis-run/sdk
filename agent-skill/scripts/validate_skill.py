...
# package -- see .github/workflows/sync-sdk-mirror.yml's own guard, which
# this mirrors for the same reason at author-time instead of only at
# publish-time.
BANNED_INFRA_TERMS = re.compile(
    r"\b(firecracker|kvm|microvm|jailer|vsock|ansible|scaleway|clickhouse|"
    r"signoz|ubicloud|control-1|control-2|exec-eu|ams1)\b|/etc/inis\b",
    re.IGNORECASE,
)
