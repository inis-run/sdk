 ...
 * across turns by a HOST-persisted session ID, with the model restricted to
 * a bounded exec/file tool surface.
 *
 ...
 * all. That split is the same one real framework adapters enforce
 ...
 * (that would be the module-global session variable this pattern rules
