...
fork it into independent children, run candidate work on each child at the
same time, and grade the results OUTSIDE the sandbox to pick a winner.
...
sessions live from the start) are covered in #912, not duplicated here.
