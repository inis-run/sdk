...
import { Client, InisError, Session, type ClientOptions, type SessionSize } from "@inis-run/sdk";
...
export class InisSandbox extends MastraSandbox {
  ...
  async getInfo(): Promise<SandboxInfo> {
    ...
    return {
      ...
      metadata: info ? { inisSessionId: info.sessionId, state: info.state, owned: this._owned } : undefined,
    };
  }
